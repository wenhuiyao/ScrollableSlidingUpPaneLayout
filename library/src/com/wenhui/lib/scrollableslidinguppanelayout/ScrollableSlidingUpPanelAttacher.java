...
public class ScrollableSlidingUpPanelAttacher implements View.OnTouchListener {
	...
	static ScrollableSlidingUpPanelAttacher getInstance(Context context){
		return new ScrollableSlidingUpPanelAttacher(context);
	}
	
	protected ScrollableSlidingUpPanelAttacher(Context context){
